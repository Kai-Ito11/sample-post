                ...
                <div class="mb-3">
                    <div class="flex items-end gap-x-3">
                        @if ($form->thumbnail && $form->thumbnail->temporaryUrl())
                            <div>
                                <img src="{{ $form->thumbnail->temporaryUrl() }}" alt="thumbnail preview" width="100" height="100" class="object-fit w-[100px] h-[100px]">
                            </div>
                        @elseif ($tmpImage)
                            <div>
                                <img src="{{ asset('storage' . $tmpImage) }}" alt="thumbnail preview" width="100" height="100" class="object-fit w-[100px] h-[100px]">
                            </div>
                        @else
